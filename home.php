...
<body>
    ...
    <div class="container justify-content-center box_home">
        <div class="d-flex flex-row justify-content-center text_home" , style="margin-top: 200px">
            <p>Hi, <?= $username ?></p>
        </div>
        <div class="row logout_btn">
            <form method="POST" action="logout.php?logout" class="logout">
