...
INSERT INTO `mahasiswa_ilkom` (`semester`, `kelas`, `kode_mk`, `nama_mk`, `sks`, `nilai`, `bobot`, `username`) VALUES
('1 2021/2022', 1000000011, 31451134, 'Kalkulus Differensial', 3, 'A-', '11.2', 'Rifan Prayoga Manik'),
...
--
ALTER TABLE `mahasiswa_ilkom`
  MODIFY `kelas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2147483648;
COMMIT;
